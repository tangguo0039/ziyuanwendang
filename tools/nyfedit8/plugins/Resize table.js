	...
	if(xNyf.isOpen()){
		...
		if(!xNyf.isReadonly()){
			...
			if(plugin.isContentEditable()){
				...
				var sCode='dom.tableCssUtil("width");';
				var sOld=plugin.runDomScript(-1, sCode, 1000); if(sOld==='undefined') sOld='';
				...
				if(vRes && vRes.length>0){
					...
					sCode='dom.beginEdit(); dom.tableCssUtil("width", "%WIDTH%"); dom.endEdit(300);'.replace(/%WIDTH%/, sVal);
