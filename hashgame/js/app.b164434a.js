(function (t) {
    ...
    0: function (t, e, a) {
        ...
        var n = function () {
                ...
                }, [t._v(t._s(t.$t("tips2")))]), t._v(" 赔率1.98 全网最高 ")]), n("div", {
                    staticClass: "line-item d-flex align-center"
                }, [n("span", {
                    staticClass: "circle"
                }), n("span", {
        ...
        var n = function () {
                ...
                }, [t._v(t._s(t.$t("tips15")))]), t._v(" 转账后，该笔交易生成的区块哈希值（Block Hash），如果最后两位同时包括数字和字母(1a,a1)，则为双尾哈希，将获得奖励，如果最后两位为字母和字母(fa)或者数字和数字(31)，则没有获奖； ")])]), t._m(0)]), a("div", {
                    staticClass: "contain"
                }, [a("div", {
                    staticClass: "title-head"
                ...
                }, [t._v(t._s(t.$t("tips15")))]), t._v(" 转账后，如果转账金额的个位数为双数（0/2/4/6/8），该笔交易生成的区块哈希值（Block Hash）最后一个数字也是双数，将获得奖励；如果转账金额的个位数为单数（1/3/5/7/9），该笔交易生成的区块哈希值（Block Hash）最后一个数字也是单数，将获得奖励； ")])]), t._m(1)]), a("div", {
                    staticClass: "contain"
                }, [a("div", {
                    staticClass: "title-head"
                ...
                }, [t._v(t._s(t.$t("tips15")))]), t._v(" 转账后，如果转账金额的个位数为双数（0/2/4/6/8），代表押大，如果转账金额的个位数为单数（1/3/5/7/9），代表押小； 该笔交易生成的区块哈希值（Block Hash）最后一个数字是0～4为小，是5～9为大； ")])]), t._m(2)])])])
            },
            s = [
                function () {
                    var t = this,
                    ...
                    return a("div", {
                        ...
                        staticClass: "sub-content"
                    }, [t._v(" 示例：如中奖，系统将在 10 秒内对您进⾏1.98倍奖励返还，如您转账100TRX，该笔交易的区块哈希值（Block Hash）为0x******796d，该哈希值最后两位为数字和字母，则中奖，将返还您198TRX。 ")])])
                },
                function () {
                    var t = this,
                        e = t.$createElement,
                    ...
                    return a("div", {
                        ...
                        staticClass: "sub-content"
                    }, [t._v(" 示例：如中奖，系统将在10秒内对您进行1.98倍奖励返还，如您转账101TRX，该笔交易的区块哈希值（Block Hash）为0x******9e3a，该哈希值最后一个数字为单数，转账金额个位数为单数，则中奖，将返还199.98TRX。 ")])])
                },
                function () {
                    var t = this,
                        e = t.$createElement,
                    ...
                    return a("div", {
                        ...
                        staticClass: "sub-content"
                    }, [t._v(" 示例：如中奖，系统将在10秒内对您进行1.98倍奖励返还，如您转账101TRX，该笔交易的区块哈希值（Block Hash）为0x******6g2c，该哈希值最后一个数字为2，在0～4区间，转账金额个位数为单数，代表押小，则中奖，将返还199.98TRX。 ")])])
                }
            ],
            i = (a("b680"), {
                name: "LayoutSecond",
        ...
        var n = function () {
                ...
                }, [t._v(" 如果您需要使用USDT兑换TRX币或使用TRX币兑换USDT币，可以向下方地址转账，平台将免费在10秒内给您返还同等价值的TRX或USDT币。 ")]), a("div", {
            ...
            s = [
                function () {
                    ...
                    }, [t._v(" 当前兑换率："), a("span", [t._v("兑换数量=（接收数量*市场价）- 油费")])])])
                },
                function () {
                    var t = this,
                        e = t.$createElement,
                    ...
                    return a("div", {
                        ...
                        staticClass: "exchange-tips"
                    }, [t._v(" TRX(USDT)最低兑换金额:"), a("span", [t._v(" 10 ")]), t._v("USDT ")])])
                }
            ],
            i = a("f923"),
            o = {
                ...
                methods: {
                    changeMenu: function (t) {
                        ...
                        this.exchangeValue1 < 1 ? this.$dialog.notify.error("请输入兑换数量") : 1 === this.exchangeMenu ? this.exchangeValue2 = this.exchangeValue1 / this.$store.state.trxUsdtPrice * .96 : this.exchangeValue2 = this.exchangeValue1 * this.$store.state.trxUsdtPrice * .96
                    }
                }
            },
            r = o,
        ...
        var n = function () {
            ...
            s = [
                function () {
                    ...
                    }, [a("div", [t._v("布洛克区块链")]), a("div", [t._v("自主研发、安全可信的区块链技术服务商")])])
                }
            ];
        a("cb29");
        ...
        var n = function () {
                ...
                return n("div", {
                    ...
                    staticClass: "btn text-center d-flex align-center btn-sm btn-copy"
                }, [t._v(" 招商客服: "), t.$store.state.onLineTelegram2 ? n("span", {
                    on: {
                        click: function (e) {
        ...
        t.exports = JSON.parse('{"33":"双尾哈","34":"单双哈","35":"大小哈","36":"转账金额","37":"HASH地址","38":"HASH组合","39":"结果公示","40":"回款金币","41":"已中奖","42":"未中奖","43":"字母","44":"数字","45":"双","46":"单","47":"小","48":"大","49":"参与流程","50":"注册数字币【去中心化】钱包","51":"数字币交易所中购买TRX币","52":"向官方指定地址转账参与游戏","53":"中奖后自动秒赔","54":"注册钱包","55":"购买虚拟币","56":"转账参与","57":"自动秒赔","58":"平台","59":"网址","60":"教程","61":"查看教程","62":"向下方地址按规定金额转账后即成功参与游戏","63":"平台官方收款地址","64":"区块哈希值符合您参与玩法的中奖规则，即可获得对应的奖励！","65":"平台优势","66":"公平透明","67":"区块哈希值在去中心化的区块链网络中随机生成，唯一且不可篡改，任何人都可以在区块链上查询记录，所有数据不能人为操控","68":"安全可靠","69":"保障用户信息及财产安全，无需注册和绑定个人信息，无需充值存款和提款审核，没有流水限制和冻卡风险，平台奖池随时可查","70":"自动秒赔","71":"极简流程，转账后即开奖，三种玩法可选，简单易懂，中奖后10秒内自动执行打款到账，游戏不间断，随时随地都能参与","72":"月盈利排行","73":"周盈利排行","74":"日盈利排行","75":"排名","76":"地址","77":"币种","78":"总派彩","79":"常见问题","80":"什么是区块哈希值","81":"区块哈希值是去中心化的区块链网络，在转账时自动生成的一段字母与数字混合的数列，记录了转账的发起方，接收方，转账金额等信息，哈希值是唯一且不可篡改的。","82":"为什么要选择去中心化钱包","83":"中心化钱包是所有用户共用一个钱包地址进行转账，无法查询哪一笔是您的转账，无法获取属于您的哈希值，去中心化钱包只记录您的转账记录，可以获取属于您的哈希值。","84":"为什么我会连续中奖或连续不中奖","85":"首先连续多次不中奖的是小概率事件，其次中奖与不中奖是随机事件，随机事件的发生频率会趋于一个稳定值，事物出现的概率对每个人来讲是相等的，这个情况下，每个人都是公平的；同时随机事件会遵大数定律（在试验不变的条件下，重复试验多次，随机事件的频率近似于它的概率），在转账频次不断增加的情况下，中奖与不中奖的概率会趋于一个稳定值，随着转账频次增加则中奖总概率会提升。","86":"为什么我的奖励延迟到账了","87":"当您中奖后，区块链会自动执行奖励进行转账，但是当TRX链发生拥堵时，可能转账会需要一些时间，请您耐心等待，平台会保证您的资金安全。","88":"单","89":"双","90":"大","91":"小","92":"数字币兑换","common":{"selectLanguage":"CN","copy":"复制"},"menu":{"menu1":"转账地址","menu2":"中奖规则","menu3":"参与流程","menu4":"平台优势","menu5":"排行榜","menu6":"常见问题"},"onlineService":"客服","tips1":"HASH 数字货币抽奖平台","tips2":"公平","tips3":"公开","tips4":"公正","tips5":"多倍奖励 行业最高","tips6":"哈希结果 唯一可查","tips7":"中奖资产 自动秒赔","tips8":"双尾哈希地址","tips9":"单双哈希地址","tips10":"大小哈希地址","tips11":"中奖规则","tips12":"双尾哈希中奖规则","tips13":"转账后，该笔交易生成的哈希值（Block Hash），如果最后两位同时包括数字和字母(1a,a1)，则为双尾哈希，将获得奖励，如果最后两位为字母和字母(fa)或者数字和数字(31)，则没有获奖；","tips14":"示例：如中奖，系统将在 10 秒内对您进⾏{peiLv}倍奖励返还，如您转账50TRX，该笔交易哈希为0x******796d，该哈希值最后两位为数字和字母，则中奖，将返还您{result}TRX。","tips15":"官方指定地址","tips16":"向","tips17":"单双哈希中奖规则","tips18":"转账，如果转账金额的个位数为双数（0/2/4/6/8），该笔交易生成的哈希值（Block Hash）最后一个数字也是双数，将获得奖励；如果转账金额的个位数为单数（1/3/5/7/9），该笔交易生成的哈希值（Block Hash）最后一个数字也是单数，将获得奖励；","tips19":"示例：如中奖，系统将在10秒内对您进行{peiLv}倍奖励返还，如您转账101TRX，该笔交易哈希为0x******9e3a，该哈希值最后一个数字为单数，转账金额个位数为单数，则中奖，将返还{result}TRX。","tips20":"大小哈希中奖规则","tips21":"转账，如果转账金额的个位数为双数（0/2/4/6/8），代表押大，如果转账金额的个位数为单数（1/3/5/7/9），代表押小； 该笔交易生成的哈希值（Block Hash）最后一个数字是0～4为小，是5～9为大；","tips22":"示例：如中奖，系统将在10秒内对您进行{peiLv}倍奖励返还，如您转账101TRX，该笔交易哈希为0x******6g2c，该哈希值最后一个数字为2，在0～4区间，转账金额个位数为单数，代表押小，则中奖，将返还{result}TRX。","tips23":"金额限制","tips24":"转账支持TRX和TRC20USDT","tips25":"TRX转账金额最小为 <span  class=\\"sub-content-innnnnn\\">{min}</span> ，最大为 <span  class=\\"sub-content-innnnnn\\">{max}</span>","tips26":"TRC20USDT转账金额最小为<span class=\\"sub-content-innnnnn\\">{min}</span> ，最大为<span class=\\"sub-content-innnnnn\\">{max}</span>","tips27":"转账低于最小金额时，不可以参与且不会退回，转账高于最大金额时，扣除手续费后退回","tips28":"转账仅支持整数币，小数部分将自动忽略","tips29":"路单图","tips30":"单双哈希路单","tips31":"大小哈希路单","tips32":"中奖实例"}')
    }, c4a1: function (t, e, a) {
        "use strict";
        a.r(e);
        var n = function () {
        ...
        var n = function () {
            ...
            s = [
                function () {
                    ...
                    return a("div", {
                        staticClass: "inn-content-content"
                    }, [a("h1", [t._v("轻松添加页面全屏背景")]), a("div", [t._v("轻松添加页面全屏背景")])])
                }
            ],
            i = a("a5f4"),
            o = {
            ...
            methods: {
                copyText: function (t) {
                    ...
                    a.on("success", (function () {
                        e.$dialog.notify.success("复制成功"), a.destroy()
                    })), a.on("error", (function () {
                        this.$dialog.notify.error("复制失败"), a.destroy()
                    }))
                }
            }
        }
