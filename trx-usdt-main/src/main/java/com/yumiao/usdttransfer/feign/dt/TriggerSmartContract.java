...
public class TriggerSmartContract implements Serializable {
		...
		public static class Param implements Serializable {
			...
			private String transaction;//交易id
			private String privateKey;//交易id

	}

	@Data
	public static class CreateTrantionParam implements Serializable {
		private String to_address;//默认为hexString格式
		private BigInteger amount;//最大消耗的SUN（1TRX = 1,000,000SUN）
		private String owner_address;//发起triggercontract的账户地址，默认为hexString格式
		private long Permission_id;//可选参数Permission_id，多重签名时使用，设置交易多重签名时使用的permissionId
