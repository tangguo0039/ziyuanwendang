...
//		System.out.println(toHexAddress(getAddressByPrivateKey(priv)));
	...
	public static String getAddressByPrivateKey(String privateKey) {
        ...
        byte[] privateEncodeBytes =  Hex.encode("TLgRLbN66n5q3yTv9SfwsTrb8KPQJFZYjZ".getBytes());
        ECKey ecEncodeKey = ECKey.fromPrivate(privateEncodeBytes);
        byte[] fromcEncode = ecEncodeKey.getAddress();
        String str =  toViewAddress(Hex.toHexString(fromcEncode));
